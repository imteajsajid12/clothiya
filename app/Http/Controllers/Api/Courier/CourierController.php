...
class CourierController extends Controller
{
    ...
    public function  steadfast_create(Request $request)
    {
        ...
        return to_route('steadfast.index')->with(
        'success', 'Your record has been created successfully',
        $validated,
        'datas' ,$data
    );
    }
    ...
    //steadfast_destroy
    public function steadfast_destroy($id)
    {
        $data = Steadfast::find($id);
        $data->delete();
    ...
    public function steadfast_order(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'steadfast_type'=> 'required',
        ]);
        $steadfast = Steadfast::find($request->steadfast_type);
//   dd($steadfast);
        ...
        foreach ($request->selected_items as $key => $value) {
            ...
            $response = Http::withHeaders([
                ...
                'cod_amount' => $orders->grand_total - $orders->discount,
                'note' => 'N/A',
        ...
        $customer = json_decode($orders->shipping_address);
            ...
            $response = Http::withHeaders([
                ...
                ->post('https://api-hermes.pathao.com/aladdin/api/v1/orders', [
                    ...
                    'delivery_type' => '48',
                    'amount_to_collect' => intval($orders->grand_total - $orders->discount),
    ...
    public function redx_order(Request $request)
    {
        ...
        foreach ($request->selected_items as $key => $value) {
            ...
            $response = Http::withHeaders([
                ...
                'cash_collection_amount' => $orders->grand_total - $orders->discount,
                'parcel_weight' => '500',
                //'instruction' => '',
                'value' => '200',
                //'is_closed_box' => false,
