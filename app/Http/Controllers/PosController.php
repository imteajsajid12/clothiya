...
class PosController extends Controller
{
    ...
    {
        $products = PosUtility::product_search($request->only('category', 'brand', 'keyword', 'subcategory'));

        $stocks = new PosProductCollection($products);
        $stocks->appends(['keyword' =>  $request->keyword, 'category' => $request->category, 'brand' => $request->brand, 'subcategory' => $request->subcategory]);
        return $stocks;
    }
