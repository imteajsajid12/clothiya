...
class AdminController extends Controller
{
    ...
    public function admin_dashboard(Request $request)
    {
        ...
        $data['sale_this_month'] = Order::whereMonth('created_at', Carbon::now()->month)->where('delivery_status', '!=', 'cancelled')->sum('grand_total');
        $data['sale_last_month'] = Order::whereMonth('created_at', Carbon::now()->month -1)->where('delivery_status', '!=', 'cancelled')
        ->sum('grand_total');
//
        //dd( $data['sale_last_month']);
        ...
        // dd(Order::where('delivery_status', 'pending')->first()->delete());
