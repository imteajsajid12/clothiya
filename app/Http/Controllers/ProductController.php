...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.product.products.create', compact('categories', 'sizes'));
    }
    ...
    public function admin_product_edit(Request $request, $id)
    {
        ...
        $categories = Category::where('parent_id', 0)
            ...
            ->get();
            $sizes= SizeChart::get();
        return view('backend.product.products.edit', compact('product', 'categories', 'tags', 'lang','sizes'));
    }
