...
<div class="form-group">
    <div class=" row">
        <label class="col-sm-2 control-label" for="note">{{translate('Note')}}</label>
        <div class="col-sm-10">
            <textarea placeholder="{{translate('Note')}}" id="note" name="note" class="form-control" required></textarea>
        </div>
    </div>
</div>