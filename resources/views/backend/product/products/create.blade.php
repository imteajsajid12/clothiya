    ...
    <div class="d-sm-flex">
        ...
        <div class="page-side-nav c-scrollbar-light px-3 py-2">
            <ul class="nav nav-tabs flex-sm-column border-0" role="tablist" aria-orientation="vertical">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="frequenty-brought-product-tab" href="#frequenty-brought-product"
                        data-toggle="tab" data-target="#frequenty-brought-product" type="button" role="tab" aria-controls="frequenty-brought-product" aria-selected="false">
                        {{ translate('Frequently Brought') }}
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div class="flex-grow-1 p-sm-3 p-lg-2rem mb-2rem mb-md-0">
            ...
            <form action="{{route('products.store')}}" method="POST" enctype="multipart/form-data" enctype="multipart/form-data" id="choice_form">
                ...
                <div class="tab-content">
                                ...
                                <div class="row">
                                    <div class="col-xxl-7 col-xl-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xxl-9">
                                                <input type="number" class="form-control" name="weight" value="{{ old('weight') }}"  step="0.01" value="0.00" placeholder="0.00">
                                            </div>
                                        </div>
                                        <!-- Quantity -->
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xxl-9">
                                                <input type="number" lang="en" class="form-control" name="weight" value="{{ old('weight') }}"  value="1" min="1">
                        ...
                        <div class="bg-white p-3 p-sm-2rem">
                            ...
                            <div class="w-100">
                                ...
                                <div class="customer_choice_options mb-4" id="customer_choice_options">
                                 ...
                                 <!-- Size Charts -->
                                 <div class="form-group row">
                                    <label class="col-md-3 col-from-label">{{translate('Size Charts')}} <span class="text-danger">*</span></label>
                                    <div class="col-md-6">
                                        <select class="form-control aiz-selectpicker" name="size_chart">
                                            <option value="">{{translate('Select Size')}}</option>
                                            @foreach ($sizes as $size )
                                            <option value="{{ $size->id }} ">{{translate($size->name)}}</option>
                                            @endforeach
                    ...
                    <!-- Frequently Brought Product -->
                    <div class="tab-pane fade" id="frequenty-brought-product" role="tabpanel" aria-labelledby="frequenty-brought-product-tab">
                        <div class="bg-white p-3 p-sm-2rem">
                            <!-- tab Title -->
                            ...
                            <div class="w-100">
                                <div class="d-flex mb-4"> 
                                    ...
                                    <div class="radio mar-btm mr-3 d-flex align-items-center">
                                        ...
                                        <label for="fq_brought_select_category" class="fs-14 fw-700 mb-0 ml-2">{{translate('Select Category')}}</label>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="fq_brought_select_category_div d-none">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <select class="form-control aiz-selectpicker" data-placeholder="{{ translate('Select a Category')}}" name="fq_brought_product_category_id" data-live-search="true" required>
                                                        @foreach ($categories as $category)
