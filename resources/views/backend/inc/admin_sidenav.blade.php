                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            {{-- @can('view_all_flash_deals') --}}
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('landing_page.index') }}" class="aiz-side-nav-link">
                            ...
                            @canany(['shipping_configuration','shipping_country_setting','manage_shipping_states','manage_shipping_cities','manage_zones','manage_carriers'])
                                <li class="aiz-side-nav-item">
                                    ...
                                    <ul class="aiz-side-nav-list level-3">
                                        ...
                                        @endcan
                                        <li class="aiz-side-nav-item">
                                            <a href="{{route('shipping.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['shipping.index','shipping.edit'])}}">
