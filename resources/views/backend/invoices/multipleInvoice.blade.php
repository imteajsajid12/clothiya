                                ...
                                <table class="text-right sm-padding small strong">
                                    <tbody>
                                        ...
                                        <tr class="border-bottom">
                                            ...
                                            <td class="currency">{{ single_price($order->discount ?? $order->coupon_discount ) }}</td>
                                        </tr>
                                        <tr>
                                            <th class="text-left strong">{{ translate('Grand Total') }}</th>
                                            <td class="currency">{{ single_price($order->grand_total - $order->discount ?? $order->coupon_discount) }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
