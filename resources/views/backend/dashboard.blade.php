                    ...
                    <div class="col-sm-6">
                        <div class="dashboard-box bg-soft-primary mb-2rem overflow-hidden" style="height: 470px;">
                            <div class="d-flex flex-column justify-content-between h-100">
                                ...
                                <div
                                    class="d-flex align-items-center justify-content-between p-3 rounded-2 bg-danger text-white mr-2 mt-2">
                                    <h3 class="fs-13 fw-600 mb-0">
                                        {{ translate('Sales last month') }}
                                    </h3>
                                    <h3 class="fs-13 fw-600 mb-0">
                                        {{ single_price($sale_last_month) }}
                                    </h3>
                                </div>
                                <!-- Sales Stat -->
                                <div>
