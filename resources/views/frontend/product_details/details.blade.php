<div class="text-left">
    ...
    <div class="d-flex flex-wrap align-items-center">
        ...
        @php
            ...
            $sizeChartId = $detailedProduct->size_chart  ;
    ...
    {{-- size charts --}}
    @if($sizeChartId != 0)
    @include('backend.product.sizeCharts.show')
 @endif
{{-- size charts --}}
...
//    showSizeChartDetail("{{ $sizeChartId }}, {{ $sizeChartName }}");
...
<script type = "text/javascript">
   ...
   items: [
 {
   ...
   index: 0,
   item_brand: "{{ $detailedProduct->brands->name ?? 'N/A' }}",
   item_category: "{{ $detailedProduct->main_category->name }}",
   item_variant: "{{ $detailedProduct->variant }}",
