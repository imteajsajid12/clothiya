...
@php
//  $sizeChartIds = ($product->main_category && $product->main_category->sizeChart) ? $product->main_category->sizeChart->id : 0;
$sizeChartId = $product->size_chart ?? 0; ;
// dd($sizeChartId);
...
$size_chart = \App\Models\SizeChart::findOrFail($product->size_chart ?? $sizeChartId);
