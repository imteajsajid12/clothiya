...
@endphp
<section class="py-lg-3 text-light bg-primary">
    ...
    <div class="container bg-primary">
        ...
        <!-- footer logo -->
            <div class="mt-3 mb-2 col-xl-4 col-lg-4 col-md-6 d-md-block d-none">
                ...
                <!-- footer Description -->
                <div class="mb-2 mt-2 {{ $nav_txt_color }} text-justify">
                    {!! get_setting('about_us_description',null,App::getLocale()) !!}
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-2 col-md-6 d-md-block d-none">
                <div class="text-sm-left mt-4">
                    <h4 class="fs-14 {{ $nav_txt_color }} text-uppercase fw-700 mb-3">{{ translate('Contacts') }}</h4>
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <p  class="fs-13 {{ $nav_txt_color }} mb-1">{{ translate('Address') }}</p>
                            <p  class="fs-13 {{ $nav_txt_color }}">{{ get_setting('contact_address',null,App::getLocale()) }}</p>
                        </li>
                        <li class="mb-2">
                            <p  class="fs-13 {{ $nav_txt_color }} mb-1">{{ translate('Phone') }}</p>
                            <p  class="fs-13 {{ $nav_txt_color }}">{{ get_setting('contact_phone') }}</p>
                        </li>
                        <li class="mb-2">
                            <p  class="fs-13 {{ $nav_txt_color }} mb-1">{{ translate('Email') }}</p>
                            <p  class="">
                                <a href="mailto:{{ get_setting('contact_email') }}" class="fs-13 {{ $nav_txt_color }} hov-text-primary">{{ get_setting('contact_email')  }}</a>
                            </p>
                        </li>
                    </ul>
                </div>
            ...
            <div class="col-xl-2 col-lg-2 col-md-6 col-sm-12 col-12">
                <div class="text-center text-sm-left mt-4">
                    <!-- links --> 
                        ...
                        <h4 class="fs-14 {{ $nav_txt_color }} text-uppercase fw-700 mb-3 d-md-block d-none">{{ translate('Quick Links') }}</h4>
                        <ul class="list-unstyled d-md-block d-flex justify-content-md-start justify-content-center">
                            ...
                            @foreach (json_decode( get_setting('widget_one_labels',null,App::getLocale()), true) as $key => $value)
                                ...
                                @endphp
                                    <li class="mb-2">
                                        <p class="fs-13 {{ $nav_txt_color }} mb-0">
                                            <a href="{{ $widget_one_links }}" class="fs-13 fw-700 {{ $nav_txt_color }} ml-2">
                                                {{ translate($value) }}
                                            </a>
                                        </p>    
                                    </li>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                <div class="text-center text-sm-left mt-4">
                    <h4 class="fs-14 {{ $nav_txt_color }} text-uppercase fw-700 mb-3">Follow Us</h4>
                    <!-- Follow & Apps -->
                    {{-- <div class="col-xxl-3 col-xl-4 col-lg-4"> --}}
                        <!-- Social -->
                        @if ( get_setting('show_social_links') )
...
<div class="aiz-mobile-bottom-nav d-xl-none fixed-bottom border-top border-sm-bottom border-sm-left border-sm-right mx-auto mb-sm-2" style="background-color: rgb(255 255 255 / 90%)!important;">
    <div class="row align-items-center gutters-5">
        ...
        <!-- Messages -->
        <div class="col">
            <a target="_blank" href="{{ get_setting('facebook_link') ?? null }}" class="text-secondary d-block text-center pb-2 pt-3">
                ...
                <span>
                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16" class="fill-current text-gray-500" height="16" width="16" xmlns="http://www.w3.org/2000/svg">
                ...
                <span class="d-block mt-1 fs-10 fw-600 text-reset">{{ translate('Message') }}</span>
            </a>
        </div>

        <!-- Call -->
        <div class="col">
            <a target="_blank" href="tel:+88{{ get_setting('helpline_number') }}" class="text-secondary d-block text-center pb-2 pt-3">
                ...
                <span class="d-block mt-1 fs-10 fw-600 text-reset">{{ translate('Call') }}</span>
            </a>
        </div>
        ...
        <div class="col-auto">
            <a href="{{ route('cart') }}" class="text-secondary d-block text-center pb-2 pt-3 px-3 {{ areActiveRoutes(['cart'],'svg-active')}}">
                <span class="d-inline-block position-relative px-2">
                    <svg id="Group_25499" data-name="Group 25499" xmlns="http://www.w3.org/2000/svg" width="16.001"
                         height="16"
