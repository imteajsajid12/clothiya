<style>
    ...
    <!-- Top Bar -->
    <div class="top-navbar bg-white z-1035 h-35px h-sm-auto d-none d-md-block">
        <div class="container">
            <div class="row">
            ...
            <div class="container">
                <div class="d-flex align-items-center">
                        ...
                        <a class="d-block py-20px mr-3 ml-0" href="{{ route('home') }}">
                            ...
                            @if ($header_logo != null)
                                <img src="{{ uploaded_asset($header_logo) }}" alt="{{ env('APP_NAME') }}"
                                    class="mw-100 h-30px h-md-60px mobile_logo" height="60">
                            @else
                    ...
                    <div class="d-lg-none ml-auto mr-0 d-flex">
                        <!-- cart Icon for small device -->
                        <a class="relative p-1 d-block text-reset" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static">
                            <i class="la la-shopping-cart nav-box-icon la-2x"></i>
                            <span class="cart-count absolute-top-right bg-primary ml-1 mt-1 fs-11 fw-700 text-white w-20px text-center border-rounded" style="right:47px !important;top: 3px !important;border-radius: 10px;">{{count($carts) > 0 ? count($carts) : 0 }}</span>
                        </a>
                        <!-- Cart Items -->
                        <div id="mobile_nav_cart" class="dropdown-menu dropdown-menu-right dropdown-menu-lg p-0 stop-propagation rounded-0">
                        ...
                        <!-- Search Icon for small device -->
                        <a class="p-1 ml-2 d-block text-reset" href="javascript:void(0);" data-toggle="class-toggle"
...
{{--                    </div>--}}
{{--                    <div class="text-center border-top">--}}
{{--                        <a target="_blank" href="tel:09613-100400"><p>09613-100400</p></a>--}}
...
{{--                                    class="text-reset opacity-60 hov-opacity-100 hov-text-primary fs-12 d-inline-block py-2 pl-2">{{ translate('Registration') }}</a>--}}
        ...
        <!-- Menu Bar -->
        <div class="d-none d-lg-block position-relative bg-primary h-50px menu-bar">
            <div class="container  menu-bar h-100" style="background-color: var(--primary) !important;">
