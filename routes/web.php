...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::get('/flash-deal/{slug}', ' ')->name('flash-deal-details');
    ...
    Route::get('/landingPage/{id}', 'landing_page_details')->name('landingPage.details');
});
...
Route::get('/shipping/charge/{id}', function () {
    $shipping=request('id');
    return Shipping::where('id', $shipping)->first();
});
