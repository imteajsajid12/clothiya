...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function() {
    ...
    Route::controller(BusinessSettingsController::class)->group(function () {
        ...
        Route::get('/select-invoice', [InvoiceController::class, 'select_invoice_download'])->name('select.invoice.download'); //download invoice
        // bulk invoice download
        Route::post('/bulk-invoice-download', [InvoiceController::class, 'bulk_invoice_download'])->name('bulk-invoice-download');
    });
    ...
    Route::controller(LandingPageController::class)->group(function () {
        ...
        Route::get('/landing_page/create', 'create')->name('landing_page.create');
        Route::post('/landing_page/store', 'store')->name('landing_page.store');
        Route::post('/landing_page/update', 'update')->name('landing_page.update');
        Route::get('/landing_page/edit/{id}', 'edit')->name('landing_page.edit');
        Route::get('/landing_page/destroy/{id}', 'destroy')->name('landing_page.destroy');
        Route::post('/landing_page/update_status', 'update_status')->name('landing_page.update_status');
        // Route::post('/landing_page/update_featured', 'update_featured')->name('landing_page.update_featured');
        // Route::post('/landing_page/product_discount', 'product_discount')->name('landing_page.product_discount');
        // Route::post('/landing_page/product_discount_edit', 'product_discount_edit')->name('landing_page.product_discount_edit');
    });
    ...
    Route::controller(OrderController::class)->group(function () {
        ...
        Route::get('orders_by_pickup_point', 'all_orders')->name('pick_up_point.index');
         //edit order
         Route::Post('/order/edit', 'edit_order')->name('order.edit');
         Route::Post('/order/edit_quantity', 'edit_order_quantity')->name('order.quantity_edit');
        ...
        Route::post('/orders/update_delivery_status/update', 'update_delivery_status')->name('orders.update_delivery_status');
...
//courier ApiController
Route::controller(CourierController::class)->group(function () {  // stadefast Api routes
    Route::get('/courier', 'steadfast')->name('steadfast.index');
    Route::post('/courier/steadfast', 'steadfast_order')->name('courier.steadfast');
    Route::post('/courier/steadfast_create', 'steadfast_create')->name('steadfast.create');
    Route::post('/courier/steadfast_create/order', 'steadfast_sent_order')->name('steadfast.sent_order');
    //stadefast Delete
    Route::delete('/courier/steadfast/destroy/{id}', 'steadfast_destroy')->name('steadfast.destroy');
   ...
   //Redx Api routes
    ...
    Route::controller(ShippingController::class)->group(function () {
        ...
        Route::post('/shipping/update', 'update')->name('shipping.update');
        Route::get('/shipping/edit/{id}', 'edit')->name('shipping.edit');
        Route::get('/shipping/destroy/{id}', 'destroy')->name('shipping.destroy');
        Route::post('/shipping/update_status', 'update_status')->name('shipping.update_status');
    });
